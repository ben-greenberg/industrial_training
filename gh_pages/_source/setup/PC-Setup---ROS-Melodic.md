...
The VM method is the most convenient method of utilizing the training materials:
 ...
 1. [Download ROS Melodic training VM](http://aeswiki.datasys.swri.edu/vm/ROSI_Training_Melodic_latest.ova)

^^^THIS LINK IS BROKEN, should be updated for Melodic anyway^^^
